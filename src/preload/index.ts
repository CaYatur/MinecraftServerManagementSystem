...
const api: MsmsApi = {
  ...
  setWebUserRoles: (id, roles) => ipcRenderer.invoke(IPC.webUserRoles, id, roles),
  listApiKeys: () => ipcRenderer.invoke(IPC.apiKeyList),
  createApiKey: (input) => ipcRenderer.invoke(IPC.apiKeyCreate, input),
  revokeApiKey: (keyId) => ipcRenderer.invoke(IPC.apiKeyRevoke, keyId),
  deleteApiKey: (keyId) => ipcRenderer.invoke(IPC.apiKeyDelete, keyId),
  listRoles: () => ipcRenderer.invoke(IPC.rbacList),
  upsertRole: (role) => ipcRenderer.invoke(IPC.rbacUpsert, role),
  deleteRole: (roleId) => ipcRenderer.invoke(IPC.rbacDelete, roleId),
